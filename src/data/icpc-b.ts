...
export const PROBLEMS_ICPC_B: ICPCProblem[] = [
  {
    id: 24, stage: 4, title: "Next Greater Element", pattern: "monotonic stack", skill: "pop when outgrown", difficulty: "Medium",
  ...
  {
    id: 25, stage: 4, title: "Sliding Window Maximum", pattern: "monotonic deque", skill: "front is always the max", difficulty: "Hard",
  ...
  {
    id: 26, stage: 4, title: "Min Stack", pattern: "augmented structure", skill: "mirror the state", difficulty: "Medium",
  ...
  {
    id: 27, stage: 4, title: "Friend Circles", pattern: "union-find", skill: "count components", difficulty: "Medium",
  ...
  {
    id: 28, stage: 4, title: "Redundant Connection", pattern: "union-find cycle detection", skill: "first edge closing a cycle", difficulty: "Medium",
  ...
  {
    id: 29, stage: 4, title: "Gas Station Circuit", pattern: "greedy window reset", skill: "local deficit kills the prefix", difficulty: "Medium",
  ...
  {
    id: 30, stage: 5, title: "Running Median", pattern: "two heaps", skill: "balance halves", difficulty: "Hard",
  ...
  {
    id: 31, stage: 5, title: "Merge K Sorted Lists", pattern: "k-way merge with heap", skill: "heap of heads", difficulty: "Medium",
  ...
  {
    id: 32, stage: 5, title: "Tree Diameter", pattern: "double BFS", skill: "farthest from farthest", difficulty: "Medium",
  ...
  {
    id: 33, stage: 5, title: "Subtree Sizes", pattern: "iterative DFS post-order", skill: "process children before parent", difficulty: "Medium",
  ...
  {
    id: 34, stage: 5, title: "Deepest Level Sum", pattern: "level BFS", skill: "process one layer at a time", difficulty: "Easy",
  ...
  {
    id: 35, stage: 5, title: "LCA via Binary Lifting", pattern: "binary lifting", skill: "jump in powers of two", difficulty: "Hard",
  ...
  {
    id: 36, stage: 6, title: "Maze Shortest Path", pattern: "BFS on grid", skill: "uniform cost = BFS", difficulty: "Easy",
  ...
  {
    id: 37, stage: 6, title: "Network Delay Time", pattern: "Dijkstra with heap", skill: "greedy closest frontier", difficulty: "Hard",
  ...
  {
    id: 38, stage: 6, title: "Negative Cycle Detection", pattern: "Bellman-Ford", skill: "relax V times", difficulty: "Hard",
  ...
  {
    id: 39, stage: 6, title: "All-Pairs Shortest Paths", pattern: "Floyd-Warshall", skill: "allow each vertex as intermediate", difficulty: "Medium",
  ...
  {
    id: 40, stage: 6, title: "Course Order", pattern: "Kahn topological sort", skill: "peel zero in-degree", difficulty: "Medium",
  ...
  {
    id: 41, stage: 6, title: "0-1 BFS", pattern: "deque shortest path", skill: "zero edges stay at front", difficulty: "Hard",
