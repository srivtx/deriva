...
export const TEENAGE_PATHS: Record<string, string> = {
  ...
  ghost: "M12 3.5a6.5 6.5 0 0 1 6.5 6.5v9.2l-2.16-1.7-2.17 1.7-2.17-1.7-2.17 1.7L5.5 19V10A6.5 6.5 0 0 1 12 3.5zM9.3 9.9v.01M14.7 9.9v.01",
  glyph: "M12 2l2.2 7.8L22 12l-7.8 2.2L12 22l-2.2-7.8L2 12l7.8-2.2z",
  osc: "M4 16v-5a3 3 0 0 1 6 0v5M10 11a3 3 0 0 1 6 0v5M16 13h5",
  db: "M5 6c0-1.7 3.1-3 7-3s7 1.3 7 3v12c0 1.7-3.1 3-7 3s-7-1.3-7-3zM5 6c0 1.7 3.1 3 7 3s7-1.3 7-3M5 12c0 1.7 3.1 3 7 3s7-1.3 7-3",
  ultron: "M12 7.5a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9zM12 2.5v19M2.5 12h19M5.3 5.3l13.4 13.4M18.7 5.3L5.3 18.7",
  media: "M20 12a8 8 0 1 1-16 0 8 8 0 0 1 16 0zM12 4v16M12 4a8 8 0 0 1 8 8",
  rig: "M4 4h4M4 4v4M20 4h-4M20 4v4M4 20h4M4 20v-4M20 20h-4M20 20v-4M9 9h6v6H9z",
  one: "M20 12a8 8 0 1 1-16 0 8 8 0 0 1 16 0zM12 10.5v.01",
  res: "M7 7.5v.01M17 7.5v.01M12 16.5v.01",
  pdb: "M10.5 3.5a7 7 0 1 0 0 14 7 7 0 0 0 0-14zM15.6 15.6L21 21M8 10.5h5",
