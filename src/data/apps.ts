...
export const APP_CATALOG: AppMeta[] = [
  ...
  { id: "pdb", name: "PDB", glyph: "⌖", gradient: G.pdb, desc: "92 debugging drills, red to green", category: "Practice", href: "/pdb", status: "installed" },
  ...
  { id: "design", name: "Design", glyph: "▣", gradient: G.cobalt, desc: "System design problems", category: "Explore", href: "/design", status: "installed" },
    ...
    { id: "corona", name: "CORONA", glyph: "⬡", gradient: G.corona, desc: "Heesch lab — draw a shape, ring it, climb to five", category: "Explore", href: "/corona", status: "installed" },
