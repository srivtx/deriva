...
const KIND_LABEL: Record<AppNotification["kind"], string> = { practice: "DSA practice", patterns: "Pattern Desk", design: "System design", lld: "Low-level design", quiz: "Pattern quiz", review: "Review queue" }
