...
const MORE_GROUPS: MoreGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Foundry", href: "/foundry", desc: "AI production workshop" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "CORONA", href: "/corona", desc: "heesch-number lab" },
...
function Breadcrumbs() {
  ...
  } else if (pathname === "/corona") {
    parts.push({ label: "CORONA Lab", href: "/corona" })
