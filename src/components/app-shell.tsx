...
const MORE_GROUPS: MoreGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "KYMA", href: "/kyma", desc: "pattern-formation lab" },
...
function Breadcrumbs() {
  ...
  } else if (pathname === "/kyma") {
    parts.push({ label: "KYMA Lab", href: "/kyma" })
...
function ProgressBadge({ className = "" }: { className?: string }) {
  ...
  const APP_MODE_PREFIXES = ["/daily", "/review", "/contest", "/interview", "/icpc", "/one", "/pdb", "/kyma", "/res", "/atlas", "/cheatsheets", "/playground", "/complexity", "/notebook", "/toolkit", "/releases", "/android", "/settings", "/dashboard", "/observatory", "/practice", "/topic", "/patterns", "/ai-ml", "/design", "/lld", "/db", "/lab", "/expedition", "/games", "/learn", "/vault", "/weather", "/images", "/qr", "/whiteboard", "/media", "/ultron", "/store", "/expenses", "/calendar", "/translate", "/focus", "/glyph", "/ghost", "/osc", "/rig"]
