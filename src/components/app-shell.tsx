...
function ProgressBadge({ className = "" }: { className?: string }) {
  ...
  const APP_MODE_PREFIXES = ["/daily", "/review", "/contest", "/interview", "/icpc", "/atlas", "/cheatsheets", "/playground", "/complexity", "/notebook", "/toolkit", "/releases", "/android", "/settings", "/dashboard", "/observatory", "/practice", "/topic", "/patterns", "/ai-ml", "/design", "/lld", "/lab", "/expedition", "/games", "/learn", "/vault", "/weather", "/images", "/qr", "/whiteboard", "/store", "/expenses", "/calendar", "/translate", "/focus", "/glyph", "/ghost", "/osc"]
         ...
         @media (max-width: 700px) {
           ...
           .mobile-progress .progress-badge > div { width: 30px !important; }
            ...
            .mobile-header-actions { display: flex; align-items: center; gap: 2px; }
             ...
             body.app-mode-active { display: flex; flex-direction: column; height: 100vh; height: 100dvh; overflow: hidden; }
             body.app-mode-active .app-content { flex: 1 1 auto; height: auto; min-height: 0; overflow-y: auto; -webkit-overflow-scrolling: touch; overscroll-behavior-y: contain; padding-top: var(--mobile-header-height); padding-bottom: env(safe-area-inset-bottom); }
